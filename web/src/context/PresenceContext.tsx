...
import { fetchPresence, type PresenceEntry } from "../api/presence";
...
export function PresenceProvider({ children }: { children: ReactNode }) {
  ...
  const watch = useCallback(
    (userIds: Array<number | null | undefined>) => {
      ...
      flushTimerRef.current = window.setTimeout(flushWatch, 40);
    },
    [flushWatch, selfId]
  );
  ...
  useEffect(() => {
    ...
    if (document.visibilityState !== "visible") emitPresenceAway();
