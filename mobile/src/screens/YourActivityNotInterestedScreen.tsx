...
export function YourActivityNotInterestedScreen() {
  ...
  return (
    <SafeAreaView style={styles.screen} edges={["top", "bottom"]}>
      <View style={styles.topBar}>
        ...
        <Text style={styles.topTitle}>Not Interested</Text>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        {!loading && filtered.length === 0 ? <View style={styles.emptyWrap}><Text style={styles.emptyText}>No not-interested content yet.</Text></View> : null}
