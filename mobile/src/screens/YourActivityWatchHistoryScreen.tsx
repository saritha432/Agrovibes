...
export function YourActivityWatchHistoryScreen() {
  ...
  useFocusEffect(
    React.useCallback(() => {
      ...
      const load = async () => {
        ...
        setLoading(true);
        try {
          // Fallback source until dedicated watch-history API is available.
  ...
  return (
    <SafeAreaView style={styles.screen} edges={["top", "bottom"]}>
      <View style={styles.topBar}>
        ...
        <Text style={styles.topTitle}>Watch History</Text>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        {!loading && filtered.length === 0 ? <View style={styles.emptyWrap}><Text style={styles.emptyText}>No watch history yet.</Text></View> : null}
