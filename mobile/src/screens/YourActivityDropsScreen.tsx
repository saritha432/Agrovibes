...
export function YourActivityDropsScreen() {
  ...
  return (
    <SafeAreaView style={styles.screen} edges={["top", "bottom"]}>
      <View style={styles.topBar}>
        ...
        <Text style={styles.topTitle}>Drops</Text>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        {!loading && filtered.length === 0 ? <View style={styles.emptyWrap}><Text style={styles.emptyText}>No drops found.</Text></View> : null}
      ...
      <PostsReelViewerModal
        ...
        onPostsChange={(next) => {
          ...
          setViewer((prev) => (prev ? { ...prev, posts: next } : prev));
        }}
        canDeleteOwnPosts
      />
    </SafeAreaView>
...
const styles = StyleSheet.create({
  ...
  plusBtn: { width: 26, height: 26, alignItems: "center", justifyContent: "center" },
