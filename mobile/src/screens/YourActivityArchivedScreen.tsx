...
export function YourActivityArchivedScreen() {
  ...
  return (
    <SafeAreaView style={styles.screen} edges={["top", "bottom"]}>
      <View style={styles.topBar}>
        ...
        <Text style={styles.topTitle}>Archived</Text>
      ...
      <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.filtersBarContent} style={styles.filtersBar}>
        <View style={styles.filterChip}><Text style={styles.filterChipText}>Newest to oldest</Text><Ionicons name="chevron-down" size={14} color={APP_TEXT_MUTED} /></View>
        <View style={styles.filterChip}><Text style={styles.filterChipText}>All dates</Text><Ionicons name="chevron-down" size={14} color={APP_TEXT_MUTED} /></View>
      </ScrollView>
      <View style={styles.emptyWrap}><Text style={styles.emptyText}>No archived posts yet.</Text></View>
    </SafeAreaView>
  );
}
